...
SenseFlow Live is a real-time speech transcription and meeting intelligence workspace built on FunASR. It combines streaming ASR, incremental and full summaries, action items, open questions, and interactive Q&A in a single web UI.

Note: The remaining sections keep the upstream FunASR toolkit documentation.
